...
// "23/05/2009" → "2009-05-23" (returns "" if incomplete)
        ...
        <Modal open onClose={onClose} title={isEdit ? "Editar estudiante" : "Nuevo estudiante"} footer={footer}>
            <form id="estudiante-form" onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "0.875rem" }}>
                ...
                <div className={styles.row2}>
                    ...
                    <FormField label={`Fecha de nacimiento${previewAge !== null ? ` · ${previewAge} años` : ""}${form.fechaNacimiento && !dateOk ? " · fecha inválida" : ""}`}>
                            ...
                            asigCatalogue.map((asig) => (
                                <label key={asig.id} className={styles.asigOption}>
                                    ...
                                    <span className={styles.asigOptionLabel}>
                                        ...
                                        <span>· {asig.grupo}-{asig.seccion} · {asig.año}</span>
                                    </span>
                                </label>
                            ))
                        )}
        ...
        <tr>
            ...
            <td>
                <div className={styles.asigChips}>
                    {visible.map((a) => (
                        <span key={a.id} className={styles.asigChip} title={`${a.nombre} · Grupo ${a.grupo}-${a.seccion} · ${a.año}`}>
...
export function EstudiantesPage() {
    ...
    const asigCatalogue: AsigRef[] = asignaturas.map((a) => ({ id: a.id, nombre: a.nombre, grupo: Math.trunc(a.grupo), seccion: Math.trunc(a.seccion), año: a.año }));
